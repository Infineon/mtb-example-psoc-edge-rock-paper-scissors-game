...
/*******************************************************************************
* Function Name: Image_Resize_RGB565_to_RGB888_Ratio
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void Image_Resize_RGB565_to_RGB888_Ratio( uint16_t* srcImage_RGB565, int srcWidth, int srcHeight, int channels,
...
*
*******************************************************************************/
void Image_Resize_Rect( int8_t * dstImage, int dst_w, int dst_h, int dst_c,
...
/*******************************************************************************
* Function Name: Image_Resize_Rect_Linear
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void Image_Resize_Rect_Linear( int8_t * dstImage, int dst_w, int dst_h, int dst_c,
                               int8_t * srcImage, int img_w, int img_h,
                               float xmin, float ymin, float xmax, float ymax )
{
    float   rect_w = xmax - xmin + 1.0f;
...
*
*******************************************************************************/
void Image_Crop_Rect( uint8_t * dstImage, int dst_w, int dst_h, int dst_c,
...
*
*******************************************************************************/
void Image_Extract_Rect( uint8_t * dstImage, int dst_w, int dst_h, int dst_c,
                         uint8_t * srcImage, int img_w, int img_h )
{
...
/*******************************************************************************
* Function Name: Image_Extract_Rect_u2i
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void Image_Extract_Rect_u2i( int8_t * dstImage, int dst_w, int dst_h, int dst_c,
                             uint8_t * srcImage, int img_w, int img_h )
{
    int rect_w = min( dst_w, img_w );
    int rect_h = min( dst_h, img_h );
