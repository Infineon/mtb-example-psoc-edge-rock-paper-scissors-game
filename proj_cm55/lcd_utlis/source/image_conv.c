 ...
 ********************************************************************************
* Summary: Converts a color pixel value from RGB888 to RGB565.
*
* Parameters:
...
********************************************************************************
* Summary:
*  Converts 16-bit RGB565 to 24-bit RGB value.
*
* Parameters:
*  uint32_t rgb565: RGB565 value
*
* Return:
*  uint32_t: 24-bit RGB value
*
*******************************************************************************/
inline
...
********************************************************************************
* Summary:
*  Converts RGB565 image to signed RGB888.
*
* Parameters:
*  uint32_t rgb565: RGB565 value
*  uint8_t *rgb888: destination buffer for RGB888 value
*
* Return:
*  uint8_t *: destination buffer address
*
*******************************************************************************/
inline
...
********************************************************************************
* Summary:
*  Converts a 16-bit RGB565 pixel to signed 24-bit RGB888 with zero point adjustment.
*
* Parameters:
*  uint32_t rgb565: 16-bit RGB565 pixel value
*  int8_t *rgb888: Pointer to the destination signed RGB888 buffer
*  int32_t zero_point: Zero point adjustment for the conversion
*
* Return:
*  int8_t *: Pointer to the next position in the destination buffer
*
*******************************************************************************/
inline
int8_t * ifx_pixel_RGB565_to_RGB888_u2i( uint32_t rgb565, int8_t *rgb888, int32_t zero_point )
{
    /* Extract B, G, and R components from BGR565 pixel (already in BGR order) */
...
********************************************************************************
* Summary:
*  Converts two 16-bit RGB565 pixels (packed in a 32-bit value) to signed 24-bit
*  RGB888 with zero point adjustment.
*
* Parameters:
*  uint32_t rgb565: 32-bit value containing two RGB565 pixels (low 16-bit: first pixel, high 16-bit: second pixel)
*  int8_t *rgb888: Pointer to the destination signed RGB888 buffer
*  int32_t zero_point: Zero point adjustment for the conversion
*
* Return:
...
********************************************************************************
* Summary:
*  Converts an RGB565 image to an RGB888 image using 32-bit memory access for two pixels.
*
* Parameters:
...
********************************************************************************
* Summary:
*  Converts an RGB565 image to a signed RGB888 image with zero point adjustment
*  using 32-bit memory access for two pixels.
*
* Parameters:
*  uint8_t *src_bgr565: Pointer to the source RGB565 image buffer
*  int32_t width: Width of the source image
*  int32_t height: Height of the source image
*  int8_t *dst_rgb888_i8: Pointer to the destination signed RGB888 image buffer
*  int32_t dst_width: Width of the destination image
*  int32_t dst_height: Height of the destination image
*  int32_t zero_point: Zero point adjustment for the conversion
*
...
********************************************************************************
* Summary:
*  Converts an RGB565 image to a signed RGB888 image with
*  zero point in int8_t quantization
*
* Parameters:
*  uint8_t *src_bgr565: Pointer to the source RGB565 image buffer
*  int32_t width: Width of the source image
...
*  int32_t dst_width: Width of the destination image
*  int32_t dst_height: Height of the destination image
*  float scale       : scale in int8_t quantization
*  int32_t zero_point  : zero point in int8_t quantization
*
* Return:
*  None
*
...
********************************************************************************
* Summary:
*  Converts a 16-bit RGB565 pixel to a signed 24-bit RGB888 pixel.
*
* Parameters:
*  uint32_t pixel: 16-bit RGB565 pixel value
*  int8_t *rgb888_8p: Pointer to the destination signed RGB888 buffer
*
* Return:
*  int8_t *: Pointer to the next position in the destination buffer
*
...
********************************************************************************
* Summary:
*  Converts an RGB565 image to a signed RGB888 image.
*
* Parameters:
*  uint8_t *src_bgr565: Pointer to the source RGB565 image buffer
...
********************************************************************************
* Summary:
*  Converts 24-bit RGB to 32-bit RGBX.
*
* Parameters:
...
********************************************************************************
* Summary:
*  Converts 32-bit xRGB to 16-bit RGB565.
*
* Parameters:
*  uint32_t xRGB: 32-bit xRGB value
*
* Return:
*  uint16_t: 16-bit RGB565 value
*
*******************************************************************************/
inline
...
********************************************************************************
* Summary:
*  Converts an RGBX32 image to an RGB24 image.
*
* Parameters:
...
********************************************************************************
* Summary:
*  Converts an RGBX32 image to a signed RGB24 image with zero point adjustment.
*
* Parameters:
*  uint8_t *src_rgbx32: Pointer to the source RGBX32 image buffer
*  int32_t width: Width of the source image
*  int32_t height: Height of the source image
*  int8_t *dst_rgb888: Pointer to the destination signed RGB888 image buffer
*  int32_t dst_width: Width of the destination image
*  int32_t dst_height: Height of the destination image
*  int32_t zero_point: Zero point adjustment for the conversion
*
...
/*******************************************************************************
* Function Name: IMAGE_DrawPixel
********************************************************************************
* Summary:
*   Draws pixel with RGB color to defined point.
*
* Parameters:
...
*
*******************************************************************************/
void IMAGE_DrawPixel( uint16_t *pDst, uint16_t x, uint16_t y, uint16_t r, uint16_t g, uint16_t b, uint16_t lcd_w, uint16_t lcd_h )
{
    if ( x < lcd_w  &&  y < lcd_h ) {
