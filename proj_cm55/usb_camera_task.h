...
/* This sample application will try to find a video setting matching these values,
* if the camera does not have a matching setting the very first one will be selected.
*/

/* Supported formats:
* USBH_VIDEO_VS_FORMAT_UNCOMPRESSED
* USBH_VIDEO_VS_FORMAT_MJPEG
* USBH_VIDEO_VS_FORMAT_FRAME_BASED (this is H.264)
*/
