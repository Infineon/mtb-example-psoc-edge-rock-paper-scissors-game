...
The following example clones the "[RPS game](https://github.com/Infineon/mtb-example-psoc-edge-rock-paper-scissors-game)" application with the desired name "RPSGame" configured for the *KIT_PSE84_EVAL_EPC2* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSE84_EVAL_EPC2 --app-id mtb-example-psoc-edge-rock-paper-scissors-game --user-app-name RPSGame --target-dir "C:/mtb_projects"
   ```
